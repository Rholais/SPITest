...
/* Definitions for peripheral AXI_GPIO_OLED_DC */
#define XPAR_AXI_GPIO_OLED_DC_BASEADDR 0x41240000
#define XPAR_AXI_GPIO_OLED_DC_HIGHADDR 0x4124FFFF
#define XPAR_AXI_GPIO_OLED_DC_DEVICE_ID 0
#define XPAR_AXI_GPIO_OLED_DC_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_OLED_DC_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_OLED_RES */
#define XPAR_AXI_GPIO_OLED_RES_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_OLED_RES_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_OLED_RES_DEVICE_ID 1
#define XPAR_AXI_GPIO_OLED_RES_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_OLED_RES_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_OLED_VBAT */
#define XPAR_AXI_GPIO_OLED_VBAT_BASEADDR 0x41280000
#define XPAR_AXI_GPIO_OLED_VBAT_HIGHADDR 0x4128FFFF
#define XPAR_AXI_GPIO_OLED_VBAT_DEVICE_ID 2
#define XPAR_AXI_GPIO_OLED_VBAT_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_OLED_VBAT_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_OLED_VDD */
#define XPAR_AXI_GPIO_OLED_VDD_BASEADDR 0x412C0000
#define XPAR_AXI_GPIO_OLED_VDD_HIGHADDR 0x412CFFFF
#define XPAR_AXI_GPIO_OLED_VDD_DEVICE_ID 3
#define XPAR_AXI_GPIO_OLED_VDD_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_OLED_VDD_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_OLED_DC */
#define XPAR_GPIO_0_BASEADDR 0x41240000
#define XPAR_GPIO_0_HIGHADDR 0x4124FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_OLED_DC_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_OLED_RES */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_OLED_RES_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_OLED_VBAT */
#define XPAR_GPIO_2_BASEADDR 0x41280000
#define XPAR_GPIO_2_HIGHADDR 0x4128FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_OLED_VBAT_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_OLED_VDD */
#define XPAR_GPIO_3_BASEADDR 0x412C0000
#define XPAR_GPIO_3_HIGHADDR 0x412CFFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXI_GPIO_OLED_VDD_DEVICE_ID
...
/* Definitions for peripheral AXI_SPI_OLED */
#define XPAR_AXI_SPI_OLED_DEVICE_ID 0
#define XPAR_AXI_SPI_OLED_BASEADDR 0x42000000
#define XPAR_AXI_SPI_OLED_HIGHADDR 0x4200ffff
#define XPAR_AXI_SPI_OLED_FIFO_EXIST 1
#define XPAR_AXI_SPI_OLED_SPI_SLAVE_ONLY 0
#define XPAR_AXI_SPI_OLED_NUM_SS_BITS 1
#define XPAR_AXI_SPI_OLED_NUM_TRANSFER_BITS 8
#define XPAR_AXI_SPI_OLED_SPI_MODE 0
#define XPAR_AXI_SPI_OLED_TYPE_OF_AXI4_INTERFACE 0
#define XPAR_AXI_SPI_OLED_AXI4_BASEADDR 0
#define XPAR_AXI_SPI_OLED_AXI4_HIGHADDR 0
#define XPAR_AXI_SPI_OLED_XIP_MODE 0

/* Canonical definitions for peripheral AXI_SPI_OLED */
